...
| **URL**                                                                                                     | **Body**                                                                               | **Authorization Header**                   | **Meaning**                                                                                     |
| ----------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| **GET** `/api/threads/:id`                                                                                  | None                                                                                   | `Authorization: Bearer <token>` (optional) | Retrieve a specific thread by its ID.                                                           |
| **GET** `/api/threads/category/:category_id`                                                                | None                                                                                   | `Authorization: Bearer <token>` (optional) | Retrieve all threads belonging to a specific category.                                          |
| **POST** `/api/threads`                                                                                     | `{ "title": "string", "content": "string", "category_id": "int", "tags": ["string"] }` | `Authorization: Bearer <token>`            | Create a new thread.                                                                            |
| **PUT** `/api/threads/:id`                                                                                  | `{ "title": "string", "content": "string", "tags": ["string"] }`                       | `Authorization: Bearer <token>`            | Update an existing thread by ID.                                                                |
| **DELETE** `/api/threads/:id`                                                                               | None                                                                                   | `Authorization: Bearer <token>`            | Delete an existing thread by ID.                                                                |
| **GET** `/api/followed-threads/:id?is_deleted={is_deleted}&sort_by={field}&page={number}&per_page={number}` | None                                                                                   | `Authorization: Bearer <token>`            | Retrieve threads followed by a user, with options for sorting, pagination, and deleted threads. |
...
| **URL**                                                                                                   | **Body**                                                                        | **Authorization Header**                   | **Meaning**                                                                                                      |
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------- |
| **GET** /api/followed-threads/:id?is_deleted={is_deleted}&sort_by={field}&page={number}&per_page={number} | None                                                                            | `Authorization: Bearer <token>` (optional) | Fetch all comments, optionally filtered by `thread_id`, sorted by `sort_by`, paginated by `page` and `per_page`. |
| **POST** `/api/comments`                                                                                  | `{ "thread_id": "number", "parent_comment_id": "number", "content": "string" }` | `Authorization: Bearer <token>`            | Create a new comment associated with a thread and an optional parent comment.                                    |
| **PUT** `/api/comments/:id`                                                                               | `{ "content": "string" }`                                                       | `Authorization: Bearer <token>`            | Update an existing comment's content (only if the user is the owner or has admin rights).                        |
| **DELET** `/api/comments/:id`                                                                             | None                                                                            | `Authorization: Bearer <token>`            | Delete an existing comment (only if the user is the owner or has admin rights).                                  |
...
| **URL**                                                                                     | **Body**                                                                          | **Authorization Header**                   | **Meaning**                                                                                                                              |
| ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| **GET** `/api/interactions?user_id={user_id}&thread_id={thread_id}&comment_id={comment_id}` | None                                                                              | `Authorization: Bearer <token>` (optional) | Retrieves interactions based on `user_id` and optional `thread_id` or `comment_id`. Either `thread_id` or `comment_id` must be provided. |
| **POST** `/api/interactions`                                                                | `{ "thread_id": "number", "comment_id": "number", "interaction_type": "string" }` | `Authorization: Bearer <token>`            | Creates a new interaction of type `upvote`, `downvote`, or `follow` for a thread or comment.                                             |
| **PUT** `/api/interactions/:id`                                                             | `{ "interaction_type": "string" }`                                                | `Authorization: Bearer <token>`            | Updates an existing interaction identified by `id` to a new type of interaction.                                                         |
